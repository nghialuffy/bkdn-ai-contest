...
def get_result_directory_path(instance, filename):
    time_file = str(int(instance.time_submit.timestamp()))
    return "result/{0}/{1}/{2}/{3}".format(instance.problem._id , instance.created_user._id, time_file, filename)
